...
__published:	// IDE-managed Components
	...
	void __fastcall WebModule1zakasnjelePosudbeAction(TObject *Sender, TWebRequest *Request,
          TWebResponse *Response, bool &Handled);
	void __fastcall WebModule1dodavanjeRadnikaAction(TObject *Sender, TWebRequest *Request,
          TWebResponse *Response, bool &Handled);
	void __fastcall WebModule1urediRadnikaAction(TObject *Sender, TWebRequest *Request,
          TWebResponse *Response, bool &Handled);
	void __fastcall WebModule1izbrisiRadnikaAction(TObject *Sender, TWebRequest *Request,
		  TWebResponse *Response, bool &Handled);
...
public:		// User declarations
    ...
    bool jeAdmin(const int IDzaposlenik);
};
//---------------------------------------------------------------------------
